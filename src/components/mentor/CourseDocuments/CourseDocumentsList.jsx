...
// Shimmer Loading Component (keeping the same as original)
...
const MentorCourseDocumentsList = () => {
  ...
  // FIXED: Navigate to mentor-specific view route
  const handleView = (documentId) => {
    console.log('Navigating to view document:', documentId);
    navigate(`/mentor/course-documents/view/${documentId}`);
  };
  ...
  const handleDownload = async (document) => {
    try {
      ...
      if (response.url) {
        ...
        // FIXED: Navigate to mentor-specific view route
        navigate(`/mentor/course-documents/view/${document.documentId}`);
      }
